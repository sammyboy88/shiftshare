...
public class TestWeekGridAdapter implements ListAdapter {
    ...
    public TestWeekGridAdapter(Activity ctx, Map<String, Shift> results, LocalDate[] localDates) {
        context = ctx;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TestCalendarActivity calendarActivity = (TestCalendarActivity) context;
